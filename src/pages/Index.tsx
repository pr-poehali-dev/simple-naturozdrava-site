  ...
  const products = [
    {
      ...
      description: "Натуральный увлажняющий крем на основе алоэ вера и масла жожоба",
      price: 1490,
      oldPrice: 1890,
    ...
    {
      id: 2,
      name: "Масло для волос восстанавливающее",
      description: "Комплекс натуральных масел для восстановления повреждённых волос",
      price: 1250,
      image: "/placeholder.svg",
    ...
    },
    {
      ...
      description: "Отшелушивающий скраб с молотым кофе и маслом кокоса",
      price: 890,
      image: "/placeholder.svg",
    ...
    {
      id: 4,
      name: "Сыворотка против возрастных изменений",
      description: "Концентрированная сыворотка с витамином C и гиалуроновой кислотой",
      price: 2190,
      image: "/placeholder.svg",
      category: "Уход за лицом"
    },
    {
      id: 5,
      name: "Шампунь органический",
      description: "Мягкий шампунь без сульфатов для всех типов волос",
      price: 950,
      image: "/placeholder.svg",
      category: "Уход за волосами"
    },
    {
      id: 6,
      name: "Бальзам для губ питательный",
      description: "Натуральный бальзам с пчелиным воском и маслом ши",
      price: 390,
      image: "/placeholder.svg",
